...
const SalaryAnalysis: React.FC = () => {
  ...
  const UIT_2025 = 5350;
  const LIMITE_RENTA = (7 * UIT_2025) / 12;

  const calculateNetSalary = (
    basicSalary: number,
    system: "afp" | "onp",
  ): { net: number; deduction: number; tax: number } => {
    let deduction = 0;
    let incomeTax = 0;
    ...
    if (basicSalary > LIMITE_RENTA) {
      ...
      if (baseImponible <= (5 * UIT_2025) / 12) {
        ...
        incomeTax =
          ((5 * UIT_2025) / 12) * 0.08 + (baseImponible - (5 * UIT_2025) / 12) * 0.14;
      } else if (baseImponible <= (35 * UIT_2025) / 12) {
        incomeTax =
          ((5 * UIT_2025) / 12) * 0.08 +
          ((15 * UIT_2025) / 12) * 0.14 +
          (baseImponible - (20 * UIT_2025) / 12) * 0.17;
      } else if (baseImponible <= (45 * UIT_2025) / 12) {
        incomeTax =
          ((5 * UIT_2025) / 12) * 0.08 +
          ((20 * UIT_2025) / 12) * 0.14 +
          ((35 * UIT_2025) / 12) * 0.17 +
          (baseImponible - (35 * UIT_2025) / 12) * 0.2;
      } else {
        incomeTax =
          ((5 * UIT_2025) / 12) * 0.08 +
          ((20 * UIT_2025) / 12) * 0.14 +
          ((35 * UIT_2025) / 12) * 0.17 +
          ((45 * UIT_2025) / 12) * 0.2 +
          (baseImponible - (45 * UIT_2025) / 12) * 0.3;
      }
    }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex items-center space-x-3 mb-2">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Comparación de sueldo líquido vs básico por rangos salariales
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div>
              ...
              <select
                value={pensionSystem}
                onChange={(e) =>
                  setPensionSystem(e.target.value as "both" | "afp" | "onp")
                }
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
          <div className="mb-6">
            ...
            <p className="text-gray-600">
              Visualiza cómo los descuentos afectan tu sueldo líquido en diferentes rangos
              salariales
            </p>
          </div>
            ...
            <div className="space-y-3">
              <div className="p-3 bg-blue-50 rounded-lg">
                <p className="text-sm text-blue-800">
                  <strong>Impuesto a la Renta:</strong> Comienza a aplicar desde S/{" "}
                  {LIMITE_RENTA.toLocaleString()} mensuales
                </p>
              </div>

              <div className="p-3 bg-green-50 rounded-lg">
                <p className="text-sm text-green-800">
                  <strong>Sistema ONP:</strong> Descuento fijo del 13% sobre el sueldo
                  bruto
                </p>
              </div>
              ...
              <div className="p-3 bg-purple-50 rounded-lg">
                <p className="text-sm text-purple-800">
                  <strong>Sistema AFP:</strong> Descuento variable según la AFP elegida (
                  {afpPercentage}% actual)
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="space-y-3 text-sm text-gray-700">
              <div className="flex items-start space-x-2">
                ...
                <p>
                  Los cálculos no incluyen descuentos adicionales como préstamos o seguros
                  opcionales
                </p>
              </div>
              ...
              <div className="flex items-start space-x-2">
                ...
                <p>
                  Los porcentajes AFP varían entre entidades (Prima, Profuturo, Integra,
                  Habitat)
                </p>
              </div>
              ...
              <div className="flex items-start space-x-2">
                ...
                <p>
                  El análisis está basado en la normativa tributaria vigente para 2024
                </p>
              </div>
              ...
              <div className="flex items-start space-x-2">
                ...
                <p>
                  Consulte con un especialista para casos específicos o situaciones
                  particulares
                </p>
              </div>
            </div>
